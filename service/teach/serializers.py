...
class CourseUpdateSerializer(serializers.ModelSerializer):
    ...
    #     request_user = self.instance.owner.id
    #
    #     # Проверяем, не ввел ли пользователь свой собственный ID
    #     if request_user in [author.id for author in value]:
    #         raise ValidationError('Вы не можете добавить себя как автора.')
    #
    #     return value
